...
ROOT_URLCONF = 'custom_comments.urls'
...
INSTALLED_APPS = (
    ...
    'custom_comments.articles',
    'custom_comments.mycomments',
)
...
COMMENTS_XTD_MODEL = 'custom_comments.mycomments.models.MyComment'
COMMENTS_XTD_FORM_CLASS = 'custom_comments.mycomments.forms.MyCommentForm'
