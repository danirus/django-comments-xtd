...
class AllowedCommentReactionTests(TestCase):
    ...
    def test_create_both_likeit_and_dislikeit_reactions(self):
        ...
        # the same comment. Because things can be liked and disliked at
        # the same time. Sounds crazy. It's human.
        self.test_create_LIKE_IT_reaction()
...
# The model 'tests.diary' has the 'comments_flagging_enabled' = True in
