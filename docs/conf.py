...
path_to_activate = os.path.join(os.path.abspath(os.path.curdir), "../..", activate_this)
...
copyright = u'2012, Daniel Rus Morales'
...
#version = '1.1'
version = django_comments_xtd.get_version()
# The full version, including alpha/beta/rc tags.
#release = '1.1a'
release = django_comments_xtd.get_version()
