...
docs_url = "https://django-comments-xtd.readthedocs.io/en/{release}/"
...
html_theme_options = {
    ...
    "logo": "chat-text-fill.svg",
    "logo_width": 24,
    "logo_height": 24,
    "logo_alt": "django-comments-xtd",
            ...
            "dropdown": (
                {
                    ...
                    "link": "usecases/change-user-image-or-avatar"
                },
                {
                    "text": "Only signed-in users can comment",
                    "link": "usecases/only-signed-in-can-comment"
                },
            )
        },
        {
