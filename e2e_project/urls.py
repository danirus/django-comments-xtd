...
urlpatterns = [
    ...
    path("__cypress__/", include("django_cypress.urls")),
    path("comments/", include("django_comments_xtd.urls")),
    path("user/", include("shared.users.urls")),
    path("", include("prose.urls")),
    # The following is a very long entry, because it includes
    # all the URLs declared after.
    path(
        "",
        HomepageView.as_view(
            extra_context={
                ...
                "default_theme_mockups": [
                    {
                        "title": "01: Comments not allowed",
                        "url1": "01-def-light--comments-not-allowed",
                        "url2": "01-def-dark--comments-not-allowed",
                    },
                    {
                        "title": "02: form.html",
                        "url1": "02-def-light--comment-form",
                        "url2": "02-def-dark--comment-form",
                    },
                    {
                        "title": "03: form_js.html (does logout)",
                        "url1": "03-logout-and-def-light--comment-form-js",
                        "url2": "03-logout-and-def-dark--comment-form-js",
                    },
                    {
                        "title": "04: preview.html level 0 (does logout)",
                        "url1": "04-logout-and-def-light--preview-level-0",
                        "url2": "04-logout-and-def-dark--preview-level-0",
                    },
                    {
                        "title": "05: preview.html level 1 (does logout)",
                        "url1": "05-logout-and-def-light--preview-level-1",
                        "url2": "05-logout-and-def-dark--preview-level-1",
                    },
                    {
                        "title": "06: reply.html (without options)",
                        "url1": "06-def-light--reply",
                        "url2": "06-def-dark--reply",
                    },
                    {
                        "title": "07: reply.html (with votes, flags, reactions)",
                        "url1": "07-def-light--reply-ii",
                    ...
                    {
                        "title": "11: moderated.html",
                        "url1": "11-def-light--moderated",
                        "url2": "11-def-dark--moderated",
                    },
                    {
                        "title": "12: moderated_js.html (requires login)",
                        "url1": "12-def-light--moderated_js",
                        "url2": "12-def-dark--moderated_js",
                    },
                    {
                        "title": "13: muted.html",
                        "url1": "13-def-light--muted",
                        "url2": "13-def-dark--muted",
                    },
                    {
                        "title": "14: posted.html",
                        "url1": "14-def-light--posted",
                        "url2": "14-def-dark--posted",
                    },
                    {
                        "title": "15: posted_js.html (does logout)",
                        "url1": "15-logout-and-def-light--comment-posted-js",
                        "url2": "15-logout-and-def-dark--comment-posted-js",
                    },
                    {
                        "title": "16: published_js.html (requires login)",
                        "url1": "16-def-light--comment-published-js",
    ...
    path(
        "01-def-light--comments-not-allowed",
        prose_v("ArticleCommentsL0", "comments-not-allowed"),
        {"theme": "", "cscheme": "light"},
        name="01-def-light--comments-not-allowed",
    ),
    path(
        "01-def-dark--comments-not-allowed",
        prose_v("ArticleCommentsL0", "comments-not-allowed"),
        {"theme": "", "cscheme": "dark"},
        name="01-def-dark--comments-not-allowed",
    ),
    # form.html -------------------------------------------
    path(
        "02-def-light--comment-form",
        prose_v("ArticleCommentsL0", "comment-form"),
        {"theme": "", "cscheme": "light"},
        name="02-def-light--comment-form",
    ),
    path(
        "02-def-dark--comment-form",
        prose_v("ArticleCommentsL0", "comment-form"),
        {"theme": "", "cscheme": "dark"},
        name="02-def-dark--comment-form",
    ),
    # form_js.html (does logout) --------------------------
    path(
        "03-def-light--comment-form-js",
        FormJsView.as_view(),
        {"theme": "", "cscheme": "light"},
        name="03-def-light--comment-form-js",
    ),
    path(
        "03-def-dark--comment-form-js",
        FormJsView.as_view(),
        {"theme": "", "cscheme": "dark"},
        name="03-def-dark--comment-form-js",
    ),
    path(
        "03-logout-and-def-light--comment-form-js",
        logout_and_redirect("03-def-light--comment-form-js"),
        name="03-logout-and-def-light--comment-form-js",
    ),
    path(
        "03-logout-and-def-dark--comment-form-js",
        logout_and_redirect("03-def-dark--comment-form-js"),
        name="03-logout-and-def-dark--comment-form-js",
    ),
    # preview.html level 0 (does logout) ------------------
    path(
        "04-def-light--preview-level-0",
        preview_v(reply_to=0),
        {"theme": "", "cscheme": "light"},
        name="04-def-light--preview-level-0",
    ),
    path(
        "04-def-dark--preview-level-0",
        preview_v(reply_to=0),
        {"theme": "", "cscheme": "dark"},
        name="04-def-dark--preview-level-0",
    ),
    path(
        "04-logout-and-def-light--preview-level-0",
        logout_and_redirect("04-def-light--preview-level-0"),
        name="04-logout-and-def-light--preview-level-0",
    ),
    path(
        "04-logout-and-def-dark--preview-level-0",
        logout_and_redirect("04-def-dark--preview-level-0"),
        name="04-logout-and-def-dark--preview-level-0",
    ),
    # preview.html level 1 (does logout) ------------------
    path(
        "05-def-light--preview-level-1",
        preview_v(reply_to=1),
        {"theme": "", "cscheme": "light"},
        name="05-def-light--preview-level-1",
    ),
    path(
        "05-def-dark--preview-level-1",
        preview_v(reply_to=1),
        {"theme": "", "cscheme": "dark"},
        name="05-def-dark--preview-level-1",
    ),
    path(
        "05-logout-and-def-light--preview-level-1",
        logout_and_redirect("05-def-light--preview-level-1"),
        name="05-logout-and-def-light--preview-level-1",
    ),
    path(
        "05-logout-and-def-dark--preview-level-1",
        logout_and_redirect("05-def-dark--preview-level-1"),
        name="05-logout-and-def-dark--preview-level-1",
    ),
    # reply.html (without options) ------------------------
    path(
        "06-def-light--reply",
        ReplyComment2View.as_view(),
        {"theme": "", "cscheme": "light"},
        name="06-def-light--reply",
    ),
    path(
        "06-def-dark--reply",
        ReplyComment2View.as_view(),
        {"theme": "", "cscheme": "dark"},
        name="06-def-dark--reply",
    ),
    # reply.html (with votes, flags, reactions) -----------
    path(
        "07-def-light--reply-ii",
        ReplyComment3View.as_view(),
        {"theme": "", "cscheme": "light"},
        name="07-def-light--reply-ii",
    ),
    path(
        "07-def-dark--reply-ii",
        ReplyComment3View.as_view(),
        {"theme": "", "cscheme": "dark"},
        name="07-def-dark--reply-ii",
    ),
    # bad_form.html (JS) ----------------------------------
    path(
    ...
    # moderated.html --------------------------------------
    path(
        "11-def-light--moderated",
        ModeratedView.as_view(),
        {"theme": "", "cscheme": "light"},
        name="11-def-light--moderated",
    ),
    path(
        "11-def-dark--moderated",
        ModeratedView.as_view(),
        {"theme": "", "cscheme": "dark"},
        name="11-def-dark--moderated",
    ),
    # moderated_js.html -----------------------------------
    path(
        "12-def-light--moderated_js",
        ModeratedJsView.as_view(),
        {"theme": "", "cscheme": "light"},
        name="12-def-light--moderated_js",
    ),
    path(
        "12-def-dark--moderated_js",
        ModeratedJsView.as_view(),
        {"theme": "", "cscheme": "dark"},
        name="12-def-dark--moderated_js",
    ),
    # muted.html ------------------------------------------
    path(
        "13-def-light--muted",
        MutedView.as_view(),
        {"theme": "", "cscheme": "light"},
        name="13-def-light--muted",
    ),
    path(
        "13-def-dark--muted",
        MutedView.as_view(),
        {"theme": "", "cscheme": "dark"},
        name="13-def-dark--muted",
    ),
    # posted.html -----------------------------------------
    path(
        "14-def-light--posted",
        PostedView.as_view(),
        {"theme": "", "cscheme": "light"},
        name="14-def-light--posted",
    ),
    path(
        "14-def-dark--posted",
        PostedView.as_view(),
        {"theme": "", "cscheme": "dark"},
        name="14-def-dark--posted",
    ),
    # posted_js.html (does logout) ------------------------
    path(
        "15-def_light__comment_posted_js",
        PostedJsView.as_view(),
        {"theme": "", "cscheme": "light"},
        name="15-def_light__comment_posted_js",
    ),
    path(
        "15-def_dark__comment_posted_js",
        PostedJsView.as_view(),
        {"theme": "", "cscheme": "dark"},
        name="15-def_dark__comment_posted_js",
    ),
    path(
        "15-logout-and-def-light--comment-posted-js",
        logout_and_redirect("15-def_light__comment_posted_js"),
        name="15-logout-and-def-light--comment-posted-js",
    ),
    path(
        "15-logout-and-def-dark--comment-posted-js",
        logout_and_redirect("15-def_dark__comment_posted_js"),
        name="15-logout-and-def-dark--comment-posted-js",
    ),
    # published_js.html (requires login) ------------------
    path(
        "16-def-light--comment-published-js",
        PublishedJsView.as_view(),
        {"theme": "", "cscheme": "light"},
        name="16-def-light--comment-published-js",
    ),
    path(
        "16-def-dark--comment-published-js",
        PublishedJsView.as_view(),
        {"theme": "", "cscheme": "dark"},
        name="16-def-dark--comment-published-js",
    ),
